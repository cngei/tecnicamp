      ...
      <Box display="flex" flexDirection="column" gap={2} width="100%" mx={0}>
        <Container sx={{ py: 2 }}>
          <Alert icon={<Info fontSize="inherit" />} severity="info">
            Le iscrizioni apriranno <strong>venerdì 15 maggio</strong> e
          ...
          <Accordion>
            ...
            <AccordionDetails>
              ...
              <List>
                <ListItem>
                  1. Bonifico cumulativo da parte della tua sezione
                </ListItem>
                <ListItem>2. Pagare tramite bonifico bancario</ListItem>
                <ListItem>3. Pagare tramite PayPal</ListItem>
              </List>
              L'iscrizione è confermata solo dopo il pagamento, consigliamo di
          ...
          <Accordion>
            ...
            <AccordionDetails>
              Contatta subito il tuo Capo Reparto e chiedigli di verificare se
              la mail indicata nella tua anagrafica presente app.cngei.it è
              corretta, facendo attenzione ad eventuali spazi bianchi o punti
              inseriti nel campo.
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            <AccordionDetails>
              Clicca il pulsante <strong>Richieste di assistenza</strong> in
              alto e segui le istruzioni. <strong>Se e solo se</strong> non
              riesci a creare un ticket, contattaci all'indirizzo help@cngei.it
            </AccordionDetails>
          </Accordion>
          <Accordion>
            <AccordionSummary expandIcon={<ExpandMore />}>
              <Typography component="span">
                Il corso che volevo fare è già completo. Posso mettermi in lista
                di attesa?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              La lista di attesa non esiste. Non scoraggiarti, non ti resta che
              iscriverti ad un altro corso Tecnicamp. Siamo sicuri che saprai
              scegliere una valida alternativa tra le numerose proposte. Puoi
              comunque indicare nel modulo il corso “desiderato” che risulta
              però completo; se dovesse liberarsi un posto, terremo conto del
              tuo desiderio.
            </AccordionDetails>
          </Accordion>
          <Accordion>
            <AccordionSummary expandIcon={<ExpandMore />}>
              <Typography component="span">
                Devo modificare il contenuto della mia iscrizione. Cosa faccio?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              Non è possibile modificare il contenuto in autonomia. Apri un
              ticket di assistenza spiegando le modifiche da fare.
            </AccordionDetails>
          </Accordion>
          <Accordion>
            <AccordionSummary expandIcon={<ExpandMore />}>
              <Typography component="span">
                Ho cambiato idea e voglio cambiare la scelta del corso
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              Se vuoi cambiare corso, prova a scriverci la tua nuova scelta. Non
              assicuriamo di riuscire ad accontentarti, ma proveremo a vedere se
              ci sono ancora posti liberi nel nuovo corso e ti daremo una
              risposta. Se invece vuoi scambiare il corso con un altro esplo del
              tuo reparto (e siete entrambə d’accordo), chiedi al tuo Capo
              Reparto di aprire un ticket per richiedere lo scambio.
            </AccordionDetails>
          </Accordion>
        </Container>
